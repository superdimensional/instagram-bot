...
birthMonth = browser.find_element_by_xpath("//select[@title='Month:']") 
drop = Select(birthMonth)                                               
...
# ? X button need to be pressed

# next_button = browser.find_element_by_xpath('//button[@type="button"]')
# next_button.click()

# sleep(10)
# print("clicking the x button...")

# x_button = browser.find_element_by_xpath('//button[@class="wpO6b  "]')
# x_button.click()
